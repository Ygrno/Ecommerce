...
public class ProductFinanceServiceTest {
    ...
    public void tryToBuy() {
        assertEquals(true, productFinanceService.tryToBuy(new DealDetails(100, "mahmoud", "1291823", "21/9", 977)));
        assertEquals(false, productFinanceService.tryToBuy(new DealDetails(100, "tamer", "1291823", "21/9", 977)));
    }
}