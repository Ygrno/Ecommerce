...
public interface IGuest {
    ...
    public boolean buy_products_in_cart(int id,String buyerName,String creditCardNumber,String expireDate,int cvv, String buyer_id,String address,String city,String country,String zip) throws Exception;   //2.8 //7
