...
public interface IStoreRole {
    ...
    public boolean edit_store_product(String user_name, String store_name, String product_name, int product_price, int product_amount); //4.1 //5.1
    public boolean remove_store_product(String user_name, String store_name);  //4.1 //5.1
    ...
    public List<PurchaseProcess> watch_store_history(String user_name, String store_name); //4.10 //5.1
    //4.11
