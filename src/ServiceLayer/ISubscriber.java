...
public interface ISubscriber {
    ...
    public String view_purchase_history(String user_name) throws JSONException;  //3.7    //changed the return boolean type to List<PurchaseProcess> and the input from none to string user_name
