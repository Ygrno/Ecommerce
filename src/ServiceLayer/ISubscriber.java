...
public interface ISubscriber {
    ...
    public boolean sign_out(String user_name) throws Exception;  //3.1
    public boolean open_store(String user_name, String store_name) throws Exception; //3.2
    public boolean write_review(String user_name, String product_name, String store_name, String review_data, int rank) throws Exception; //3.3
    public boolean rank_product(); //3.4
    public boolean rank_store();   //3.4
    public boolean send_query_to_store(String user_name,String Query) throws Exception;//3.5
    public boolean fill_complaint();      //3.6
    public String view_purchase_history(String user_name) throws Exception;  //3.7    //changed the return boolean type to List<PurchaseProcess> and the input from none to string user_name
