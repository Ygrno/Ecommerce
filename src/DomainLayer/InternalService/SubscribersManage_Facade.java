...
/*    public static Boolean openStore(String username, String name) {
    ...
    public static List<StoreOwner> GetStoreOwners(String store) throws Exception {
        return System.getSystem().get_store(store).GetStoreOwners();
    }
    public static void AddOwnerToList(String store,StoreOwner user) throws Exception {
        System.getSystem().get_store(store).GetStoreOwners().add(user);
    }
